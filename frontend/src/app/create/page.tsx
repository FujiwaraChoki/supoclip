          ...
          <div className="flex-1 min-w-0 space-y-4">
            ...
            {activeTab === "retention" && (
              <div className="space-y-5">
                ...
                <div className="space-y-2">
                  <label className="text-sm text-stone-600">Auto-trim duration preset</label>
                  <div className="grid grid-cols-4 gap-1.5">
                  ...
                  <p className="text-xs text-stone-400">Trims clips to this length; never extends past the AI-selected segment.</p>
                </div>
              </div>
            )}
